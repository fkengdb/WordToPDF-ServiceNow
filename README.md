...
![image](https://github.com/fkengdb/WordToPDF-ServiceNow/blob/main/Screenshot_2%20(2).png?raw=true)
...
1. Acesse o sistema do ServiceNow na rota coberta pela extensão (extensão só é ativada para uso na aba com as informações de change).
2. Aguarde a página carregar: repare que um pequeno quadrado cinza com texto **Arraste o arquivo .docx aqui** aparecerá flutuando no canto inferior direito do navegador.
